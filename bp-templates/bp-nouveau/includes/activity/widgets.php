...
class BP_Latest_Activities extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = apply_filters( 'bp_latest_activities', array(
			...
			'description'                 => __( 'Display the latest updates of your community having the type(s) of your choice.', 'bp-nouveau' ),
	...
	public function form( $instance ) {
		...
		?>
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php esc_html_e( 'Title:', 'bp-nouveau' ); ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
		</p>

		<p>
			<label for="<?php echo $this->get_field_id( 'max' ); ?>"><?php _e( 'Max amount to display:', 'bp-nouveau' ); ?></label>
