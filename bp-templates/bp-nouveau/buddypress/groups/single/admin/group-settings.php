...
<div class="group-settings-selections">
	...
	<fieldset class="group-status-type">
		...
		<fieldset class="public-groups">
			<legend><?php _e( 'Public Group Option', 'buddypress' ); ?></legend>

			<dl class="group-conditions">
				<dt><?php _e( 'Public Groups Conditions', 'buddypress' ); ?> </dt>
				<dd>
		...
		<fieldset class="private-groups">
			<legend><?php _e( 'Private Group Option', 'buddypress' ); ?></legend>

			<dl class="group-conditions">
				<dt><?php _e( 'Private Groups Conditions', 'buddypress' ); ?> </dt>
				<dd>
		...
		<fieldset class="hidden-groups">
			<legend><?php _e( 'Hidden Group Option', 'buddypress' ); ?></legend>

			<dl class="group-conditions">
				<dt><?php _e( 'Hidden Groups Conditions', 'buddypress' ); ?> </dt>
				<dd>
