...
<form action="<?php echo esc_url( bp_displayed_user_domain() . bp_get_settings_slug() . '/general' ); ?>" method="post" class="standard-form" id="settings-form">
	...
	<?php if ( ! is_super_admin() ) : ?>
		...
		<input type="password" name="pwd" id="pwd" size="16" value="" class="settings-input small" <?php bp_form_field_attributes( 'password' ); ?>/> &nbsp;<a href="<?php echo esc_url( wp_lostpassword_url() ); ?>"><?php _e( 'Lost your password?', 'bp-nouveau' ); ?></a>
	...
	<div class="info bp-feedback">
		...
		<p class="text"><?php _e( 'Leave password fields blank for no change', 'bp-nouveau' ); ?></p>
	</div>
