	...
	<div class="item-list-tabs no-ajax" id="subnav" role="navigation">
		<ul>
			...
			<?php if ( is_user_logged_in() ) : ?>
				...
				<li>
					<a href="#post-new" class="show-hide-new"><?php _e( 'New Topic', 'bp-next' ); ?></a>
				</li>
			...
			<li id="forums-order-select" class="last filter">
				...
				<label for="forums-order-by"><?php _e( 'Order By:', 'bp-next' ); ?></label>
				<select id="forums-order-by">
					<option value="active"><?php _e( 'Last Active', 'bp-next' ); ?></option>
					<option value="popular"><?php _e( 'Most Posts', 'bp-next' ); ?></option>
					<option value="unreplied"><?php _e( 'Unreplied', 'bp-next' ); ?></option>
		...
		<form action="" method="post" id="forum-topic-form" class="standard-form">
			<div id="new-topic-post">
				...
				<?php if ( bp_groups_auto_join() && !bp_group_is_member() ) : ?>
					<p><?php _e( 'You will auto join this group when you start a new topic.', 'bp-next' ); ?></p>
				<?php endif; ?>

				<p id="post-new"></p>
				<h4><?php _e( 'Post a New Topic:', 'bp-next' ); ?></h4>

				<label for="topic_title"><?php _e( 'Title:', 'bp-next' ); ?></label>
				<input type="text" name="topic_title" id="topic_title" value="" maxlength="100" />

				<label for="topic_text"><?php _e( 'Content:', 'bp-next' ); ?></label>
				<textarea name="topic_text" id="topic_text"></textarea>

				<label for="topic_tags"><?php _e( 'Tags (comma separated):', 'bp-next' ); ?></label>
				...
				<div class="submit">
					<input type="submit" name="submit_topic" id="submit" value="<?php esc_attr_e( 'Post Topic', 'bp-next' ); ?>" />
				</div>
