...
<div class="item-list-tabs" role="navigation">
	<ul>
		<li id="members-all" class="bp-members-primary-nav" data-bp-scope="all" data-bp-object="members">
		...
		<?php if ( is_user_logged_in() && bp_is_active( 'friends' ) && bp_get_total_friend_count( bp_loggedin_user_id() ) ) : ?>
			<li id="members-personal" class="bp-members-primary-nav" data-bp-scope="personal" data-bp-object="members">
